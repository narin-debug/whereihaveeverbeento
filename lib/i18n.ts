...
export const translations = {
  ko: {
    ...
    pickLocationLabel: "정확한 위치 선택",
    pickLocationHint: "주소를 검색하거나 지도를 클릭해 위치를 선택하세요",
    addressSearchPlaceholder: "예: 서울 강남구 테헤란로 152",
    worldAddressSearchPlaceholder: "예: Eiffel Tower, Paris",
    addressSearchButton: "검색",
    addressSearchNotFound: "주소를 찾을 수 없어요. 지도를 클릭해 위치를 선택하세요.",
    pickLocationToggle: "정확한 위치 지정 (선택)",
    photoLabel: "사진",
    ...
    backupLinkLabel: "백업",
    backupTitle: "백업 / 복구",
    backupUnlockButton: "확인",
    backupUnlocking: "확인 중...",
    backupExportLabel: "내보내기",
    backupExportButton: "백업 파일 다운로드",
    backupExporting: "내보내는 중...",
    backupRestoreLabel: "복구하기",
    backupRestoreButton: "복구하기",
    backupRestoring: "복구하는 중...",
    restoreSummary: "{restored}개 복구, {skipped}개는 이미 있어서 건너뜀",
    errorRestoreParse: "백업 파일을 읽지 못했어요. 파일이 손상되지 않았는지 확인해주세요.",
  },
  en: {
    ...
    pickLocationLabel: "Pick the exact location",
    pickLocationHint: "Search an address or click the map to choose a location",
    addressSearchPlaceholder: "e.g. 152 Teheran-ro, Gangnam-gu, Seoul",
    worldAddressSearchPlaceholder: "e.g. Eiffel Tower, Paris",
    addressSearchButton: "Search",
    addressSearchNotFound: "Couldn't find that address. Click the map to choose a location.",
    pickLocationToggle: "Set an exact location (optional)",
    photoLabel: "Photo",
    ...
    domesticHeading: "Domestic Trips",
    continentAsia: "Asia",
    ...
    allContinents: "All",
    backupLinkLabel: "Backup",
    backupTitle: "Backup / Restore",
    backupUnlockButton: "Continue",
    backupUnlocking: "Checking...",
    backupExportLabel: "Export",
    backupExportButton: "Download Backup File",
    backupExporting: "Exporting...",
    backupRestoreLabel: "Restore",
    backupRestoreButton: "Restore",
    backupRestoring: "Restoring...",
    restoreSummary: "{restored} restored, {skipped} already existed and were skipped",
    errorRestoreParse: "Couldn't read that backup file. Check that it isn't corrupted.",
  },
