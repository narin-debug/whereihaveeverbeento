...
export const translations = {
  ko: {
    ...
    blogHeading: "블로그",
    writePost: "+ 글쓰기",
    postFormTitle: "새 글 작성",
    postTitleLabel: "제목",
    postTitlePlaceholder: "제목을 입력하세요",
    postBodyLabel: "본문",
    postBodyPlaceholder: "이야기를 들려주세요",
    postPhotosLabel: "사진",
    removePhoto: "제거",
    publishPost: "발행하기",
    publishing: "발행 중...",
    blogEmpty: "아직 작성된 글이 없어요.",
    editPost: "수정",
    editPostTitle: "글 수정",
    saveEdit: "저장",
    savingEdit: "저장 중...",
  ...
  en: {
    ...
    postFormTitle: "New Post",
    postTitleLabel: "Title",
    postTitlePlaceholder: "Enter a title",
    postBodyLabel: "Body",
    postBodyPlaceholder: "Tell your story",
    postPhotosLabel: "Photos",
    removePhoto: "Remove",
    publishPost: "Publish",
